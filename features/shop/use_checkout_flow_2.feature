@checkout_flow_ui_shop_use_checkout_flow_2
Feature: Purchase a product using checkout flow 2 for a channel
    ...
    Background:
        ...
        And the store has checkout flow "sylius_order_checkout_2"
    ...
    Scenario: Complete address, shipping, payment, complete steps to purchase a product
        ...
        And I complete the shipping and payment step
